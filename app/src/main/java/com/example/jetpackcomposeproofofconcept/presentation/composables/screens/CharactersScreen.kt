...
import com.example.jetpackcomposeproofofconcept.presentation.CharactersViewModel
            ...
            state.listCharacter.forEach { character ->
                item {
                    Column(
                        ...
                        CharacterItem(character.id, character.name, character.image, character.isFavorite)
                    }
                }
            }
        }
